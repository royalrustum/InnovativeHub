...
public class ProductCategoryController extends BaseController {
	...
	public String saveCategory(@Valid @ModelAttribute("prodCategory") ProductCategory prodCategory, BindingResult bindResult,
		...
		redirectAttributes.addFlashAttribute(SiteConstants.ALERT_MSG,
				messageSource.getMessage(SiteConstants.MSG_PROD_CAT_SUCCESS,
						new Object[] { prodCategory.getCategoryName() }, locale));
	...
	public ModelAndView viewCategory(@PathVariable("id") int prodCategoryId, Locale locale) {
